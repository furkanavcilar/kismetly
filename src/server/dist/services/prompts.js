...
exports.chatSystemPrompts = exports.compatibilitySystemPrompts = exports.tarotSystemPrompts = exports.horoscopeSystemPrompts = exports.dreamSystemPrompts = exports.baseSystemPrompts = void 0;
exports.dreamUserPrompt = dreamUserPrompt;
exports.horoscopeUserPrompt = horoscopeUserPrompt;
exports.tarotUserPrompt = tarotUserPrompt;
exports.compatibilityUserPrompt = compatibilityUserPrompt;
exports.dailyGuidanceUserPrompt = dailyGuidanceUserPrompt;
exports.spiritualAdviceUserPrompt = spiritualAdviceUserPrompt;
// Base system prompts for general spiritual guidance
exports.baseSystemPrompts = {
...
function dreamUserPrompt(language, description, mood, date) {
    if (language === 'tr') {
...
// Horoscope prompts
exports.horoscopeSystemPrompts = {
...
function horoscopeUserPrompt(language, sign, timeframe) {
    const timeframeMap = {
...
function tarotUserPrompt(language, question, spreadName, cardNames, reversedCards) {
    if (language === 'tr') {
...
exports.compatibilitySystemPrompts = {
...
function compatibilityUserPrompt(language, person1, person2, details) {
    if (language === 'tr') {
...
function dailyGuidanceUserPrompt(language, sign, name, focus) {
    if (language === 'tr') {
...
function spiritualAdviceUserPrompt(language, situation, question, context) {
    if (language === 'tr') {
