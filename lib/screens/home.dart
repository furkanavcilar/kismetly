...
class _FeatureChip extends StatelessWidget {
  const _FeatureChip({
    ...
    required this.icon,
    required this.onTap,
    @Deprecated('Kullanılmıyor, eski sürümle uyumluluk için tutuluyor') this.segments,
  });
...
class _LoaderLine extends StatelessWidget {
  ...
  const _LoaderLine.legacy([
    String? semanticsLabel,
  ], {
    Key? key,
  }) : this(key: key, semanticsLabel: semanticsLabel);
...
class _ErrLine extends StatelessWidget {
  ...
  const _ErrLine.legacy(
    String message, {
    Key? key,
    VoidCallback? onRetry,
  }) : this(key: key, message: message, onRetry: onRetry);
